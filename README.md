...
<img width="3836" height="2028" alt="Capture_2026_05_21_01_41_49_942" src="https://github.com/user-attachments/assets/c359c943-2510-4ceb-bd42-3fb76b0f5def" />

*The figure above presents the performance of the AI pipeline across the four cloud classes (**Fish, Flower, Gravel, and Sugar**) using both segmentation and classification metrics. Results include **Dice Score**, **IoU**, **Accuracy**, **Precision**, **Recall**, **F1 Score**, and confusion matrices. The model achieved a **mean Dice Score of 0.606**, **mean IoU of 0.438**, and **overall F1 Score of 0.766**, demonstrating reliable performance for satellite cloud pattern recognition and segmentation.*

---

<img width="3802" height="1644" alt="Capture_2026_05_21_01_46_12_398" src="https://github.com/user-attachments/assets/6b5f08d7-9cff-4bcf-80db-baf7b2b4907d" />

*The figure above shows sample predictions generated by the AI pipeline. It compares the original satellite image, segmentation overlays, true labels, and predicted labels. The examples highlight both successful predictions and challenging cases, illustrating the model’s ability to identify cloud patterns while also showing areas where misclassification may occur.*

---

<img width="3802" height="1640" alt="Capture_2026_05_21_01_47_04_622" src="https://github.com/user-attachments/assets/78942265-343b-450b-aa89-a7bc2bf0ee40" />

*The figure below presents additional prediction examples comparing the original satellite images, segmentation overlays, and class labels. These samples demonstrate the model’s behaviour in both correctly classified and challenging scenarios, providing insight into prediction quality and segmentation performance across different cloud patterns.*
